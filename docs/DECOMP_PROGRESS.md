...
Current audited state (from `tools/sweep_matches.py`): **218 functions
have real C; 205 are exact on size and bytes; 0 are size-mismatched and
13 byte-mismatched** — the 13 being deliberately-kept documented
