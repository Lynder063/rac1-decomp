...
Current audited state (from `tools/sweep_matches.py`): **235 functions
have real C; 221 are exact on size and bytes; 0 are size-mismatched and
14 byte-mismatched** — the 14 being deliberately-kept documented
