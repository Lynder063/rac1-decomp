...
Current audited state (from `tools/sweep_matches.py`): **305 functions
have real C; 270 are exact on size and bytes; 0 are size-mismatched and
35 byte-mismatched** — the 34 being deliberately-kept documented
