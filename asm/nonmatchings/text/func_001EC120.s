...
glabel func_001EC120
    /* ED0A0 001EC120 D0FFBD27 */  addiu      $sp, $sp, -0x30
    /* ED0A4 001EC124 00008044 */  mtc1       $zero, $f0
    /* ED0A8 001EC128 2800B5E7 */  swc1       $f21, 0x28($sp)
    /* ED0AC 001EC12C 0000B07F */  sq         $s0, 0x0($sp)
    /* ED0B0 001EC130 46650046 */  mov.s      $f21, $f12
    /* ED0B4 001EC134 2000B4E7 */  swc1       $f20, 0x20($sp)
    /* ED0B8 001EC138 2D808000 */  daddu      $s0, $a0, $zero
    /* ED0BC 001EC13C 1000BF7F */  sq         $ra, 0x10($sp)
    /* ED0C0 001EC140 016D1546 */  sub.s      $f20, $f13, $f21
    /* ED0C4 001EC144 32800046 */  c.eq.s     $f16, $f0
    /* ED0C8 001EC148 000001C6 */  lwc1       $f1, 0x0($s0)
...
.align 2
  .L001EC188:
    ...
    /* ED130 001EC1B0 000000E6 */   swc1      $f0, 0x0($s0)
.align 2
  .L001EC1B4:
    /* ED134 001EC1B4 E2E6070C */  jal        func_001F9B88
    /* ED138 001EC1B8 06A30046 */   mov.s     $f12, $f20
    /* ED13C 001EC1BC 07000046 */  neg.s      $f0, $f0
    /* ED140 001EC1C0 000001C6 */  lwc1       $f1, 0x0($s0)
    /* ED144 001EC1C4 34080046 */  c.lt.s     $f1, $f0
    /* ED148 001EC1C8 00000000 */  nop
    /* ED14C 001EC1CC 06000245 */  bc1fl      .L001EC1E8
    /* ED150 001EC1D0 000000C6 */   lwc1      $f0, 0x0($s0)
    /* ED154 001EC1D4 E2E6070C */  jal        func_001F9B88
    /* ED158 001EC1D8 06A30046 */   mov.s     $f12, $f20
    /* ED15C 001EC1DC 07000046 */  neg.s      $f0, $f0
    /* ED160 001EC1E0 000000E6 */  swc1       $f0, 0x0($s0)
.align 2
  .L001EC1E4:
    /* ED164 001EC1E4 000000C6 */  lwc1       $f0, 0x0($s0)
.align 2
  .L001EC1E8:
    /* ED168 001EC1E8 1000BF7B */  lq         $ra, 0x10($sp)
    /* ED16C 001EC1EC 00A80046 */  add.s      $f0, $f21, $f0
    /* ED170 001EC1F0 0000B07B */  lq         $s0, 0x0($sp)
    /* ED174 001EC1F4 2800B5C7 */  lwc1       $f21, 0x28($sp)
    /* ED178 001EC1F8 2000B4C7 */  lwc1       $f20, 0x20($sp)
    /* ED17C 001EC1FC 0800E003 */  jr         $ra
    /* ED180 001EC200 3000BD27 */   addiu     $sp, $sp, 0x30
