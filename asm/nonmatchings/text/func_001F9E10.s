...
glabel func_001F9E10
    /* FAD90 001F9E10 0000A1D8 */  lqc2       $vf1, 0x0($5)
    /* FAD94 001F9E14 AA08814B */  vmul.xy    $vf2, $vf1, $vf1
    /* FAD98 001F9E18 8110024B */  vaddy.x    $vf2, $vf2, $vf2y
    /* FAD9C 001F9E1C 00600144 */  mfc1       $1, $f12
    /* FADA0 001F9E20 0018A148 */  qmtc2.ni   $1, $vf3
    /* FADA4 001F9E24 BE1B024A */  .word      0x4A021BBE    # vrsqrt     Q, $vf3x, $vf2x
    /* FADA8 001F9E28 00102148 */  qmfc2.ni   $1, $vf2
    /* FADAC 001F9E2C 3C080100 */  dsll32     $1, $1, 0
    /* FADB0 001F9E30 05002010 */  beqz       $1, .L001F9E48
    ...
    /* FADC0 001F9E40 0800E003 */  jr         $31
    /* FADC4 001F9E44 000081F8 */   sqc2      $vf1, 0x0($4)
.align 2
  .L001F9E48:
    /* FADC8 001F9E48 6800804B */  vadd.xy    $vf1, $vf0, $vf0
    /* FADCC 001F9E4C 00000000 */  nop
    /* FADD0 001F9E50 0800E003 */  jr         $31
    /* FADD4 001F9E54 000081F8 */   sqc2      $vf1, 0x0($4)
