...
glabel func_001F9FC0
    /* FAF40 001F9FC0 803F013C */  lui        $1, (0x3F800000 >> 16)
    /* FAF44 001F9FC4 00688044 */  mtc1       $0, $f13
    /* FAF48 001F9FC8 00008144 */  mtc1       $1, $f0
    ...
    /* FAF5C 001F9FDC 00508144 */   mtc1      $1, $f10
    /* FAF60 001F9FE0 80BF013C */  lui        $1, (0xBF800000 >> 16)
    /* FAF64 001F9FE4 05630046 */  abs.s      $f12, $f12
    /* FAF68 001F9FE8 00000000 */  nop
    /* FAF6C 001F9FEC 00508144 */  mtc1       $1, $f10
.align 2
  .L001F9FF0:
    /* FAF70 001F9FF0 41000C46 */  sub.s      $f1, $f0, $f12
    /* FAF74 001F9FF4 A09A8127 */  addiu      $1, $28, -0x6560
    /* FAF78 001F9FF8 00080444 */  mfc1       $4, $f1
    /* FAF7C 001F9FFC 82600C46 */  mul.s      $f2, $f12, $f12
    /* FAF80 001FA000 0008A448 */  qmtc2.ni   $4, $vf1
    /* FAF84 001FA004 040025C4 */  lwc1       $f5, 0x4($1)
    /* FAF88 001FA008 000024C4 */  lwc1       $f4, 0x0($1)
    ...
    /* FAF9C 001FA01C 080026C4 */  lwc1       $f6, 0x8($1)
    /* FAFA0 001FA020 0C0027C4 */  lwc1       $f7, 0xC($1)
    ...
    /* FAFB0 001FA030 C93F013C */  lui        $1, (0x3FC90FDB >> 16)
    /* FAFB4 001FA034 DB0F2134 */  ori        $1, $1, (0x3FC90FDB & 0xFFFF)
    /* FAFB8 001FA038 00108144 */  mtc1       $1, $f2
    /* FAFBC 001FA03C 00082448 */  qmfc2.ni   $4, $vf1
    /* FAFC0 001FA040 00088444 */  mtc1       $4, $f1
    /* FAFC4 001FA044 42420146 */  mul.s      $f9, $f8, $f1
    /* FAFC8 001FA048 C1120946 */  sub.s      $f11, $f2, $f9
    /* FAFCC 001FA04C 00000000 */  nop
    /* FAFD0 001FA050 0800E003 */  jr         $31
