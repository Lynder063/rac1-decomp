...
glabel func_001FA238
    /* FB1B8 001FA238 4940013C */  lui        $1, (0x40490FDB >> 16)
    /* FB1BC 001FA23C C93F023C */  lui        $2, (0x3FC90FDB >> 16)
    /* FB1C0 001FA240 DB0F2134 */  ori        $1, $1, (0x40490FDB & 0xFFFF)
    /* FB1C4 001FA244 DB0F4234 */  ori        $2, $2, (0x3FC90FDB & 0xFFFF)
    /* FB1C8 001FA248 00588244 */  mtc1       $2, $f11
    /* FB1CC 001FA24C 00488144 */  mtc1       $1, $f9
    ...
    /* FB1E0 001FA260 3D03E34B */  .word      0x4BE3033D    # vmr32.xyzw $vf3, $vf0
    ...
    /* FB1F0 001FA270 0800A18C */  lw         $1, 0x8($5)
    /* FB1F4 001FA274 00000F20 */  addi       $15, $0, 0x0 /* handwritten instruction */
    /* FB1F8 001FA278 07002010 */  beqz       $1, .L001FA298
    /* FB1FC 001FA27C 00688144 */   mtc1      $1, $f13
...
.align 2
  .L001FA298:
    /* FB218 001FA298 0400A18C */  lw         $1, 0x4($5)
    /* FB21C 001FA29C 01000F20 */  addi       $15, $0, 0x1 /* handwritten instruction */
    /* FB220 001FA2A0 15002010 */  beqz       $1, .L001FA2F8
    /* FB224 001FA2A4 00688144 */   mtc1      $1, $f13
...
.align 2
  .L001FA2B0:
    ...
    /* FB250 001FA2D0 BC29E14B */  .word      0x4BE129BC    # vmulax.xyzw ACC, $vf5, $vf1x
    /* FB254 001FA2D4 BD30E14B */  .word      0x4BE130BD    # vmadday.xyzw ACC, $vf6, $vf1y
    /* FB258 001FA2D8 4A38E14B */  vmaddz.xyzw $vf1, $vf7, $vf1z
    /* FB25C 001FA2DC BC29E24B */  .word      0x4BE229BC    # vmulax.xyzw ACC, $vf5, $vf2x
    /* FB260 001FA2E0 BD30E24B */  .word      0x4BE230BD    # vmadday.xyzw ACC, $vf6, $vf2y
    /* FB264 001FA2E4 8A38E24B */  vmaddz.xyzw $vf2, $vf7, $vf2z
    /* FB268 001FA2E8 BC29E34B */  .word      0x4BE329BC    # vmulax.xyzw ACC, $vf5, $vf3x
    /* FB26C 001FA2EC BD30E34B */  .word      0x4BE330BD    # vmadday.xyzw ACC, $vf6, $vf3y
    /* FB270 001FA2F0 CA38E34B */  vmaddz.xyzw $vf3, $vf7, $vf3z
    /* FB274 001FA2F4 00000000 */  nop
.align 2
  .L001FA2F8:
    /* FB278 001FA2F8 0000A18C */  lw         $1, 0x0($5)
    /* FB27C 001FA2FC 02000F20 */  addi       $15, $0, 0x2 /* handwritten instruction */
    /* FB280 001FA300 15002010 */  beqz       $1, .L001FA358
    /* FB284 001FA304 00688144 */   mtc1      $1, $f13
...
.align 2
  alabel func_001FA310
    ...
    /* FB2B0 001FA330 BC29E14B */  .word      0x4BE129BC    # vmulax.xyzw ACC, $vf5, $vf1x
    /* FB2B4 001FA334 BD30E14B */  .word      0x4BE130BD    # vmadday.xyzw ACC, $vf6, $vf1y
    /* FB2B8 001FA338 4A38E14B */  vmaddz.xyzw $vf1, $vf7, $vf1z
    /* FB2BC 001FA33C BC29E24B */  .word      0x4BE229BC    # vmulax.xyzw ACC, $vf5, $vf2x
    /* FB2C0 001FA340 BD30E24B */  .word      0x4BE230BD    # vmadday.xyzw ACC, $vf6, $vf2y
    /* FB2C4 001FA344 8A38E24B */  vmaddz.xyzw $vf2, $vf7, $vf2z
    /* FB2C8 001FA348 BC29E34B */  .word      0x4BE329BC    # vmulax.xyzw ACC, $vf5, $vf3x
    /* FB2CC 001FA34C BD30E34B */  .word      0x4BE330BD    # vmadday.xyzw ACC, $vf6, $vf3y
    /* FB2D0 001FA350 CA38E34B */  vmaddz.xyzw $vf3, $vf7, $vf3z
    /* FB2D4 001FA354 00000000 */  nop
.align 2
  .L001FA358:
    /* FB2D8 001FA358 000081F8 */  sqc2       $vf1, 0x0($4)
    /* FB2DC 001FA35C 100082F8 */  sqc2       $vf2, 0x10($4)
    /* FB2E0 001FA360 200083F8 */  sqc2       $vf3, 0x20($4)
    /* FB2E4 001FA364 300084F8 */  sqc2       $vf4, 0x30($4)
    /* FB2E8 001FA368 0800E003 */  jr         $31
...
.align 2
  .L001FA384:
    ...
    /* FB308 001FA388 00788044 */   mtc1      $0, $f15
...
.align 2
  .L001FA394:
    ...
    /* FB320 001FA3A0 2ABE0B3C */  lui        $11, (0xBE2AAAA4 >> 16)
    /* FB324 001FA3A4 083C0C3C */  lui        $12, (0x3C08873E >> 16)
    /* FB328 001FA3A8 4FB90D3C */  lui        $13, (0xB94FB21F >> 16)
    /* FB32C 001FA3AC 2E360E3C */  lui        $14, (0x362E9C14 >> 16)
    /* FB330 001FA3B0 82080046 */  mul.s      $f2, $f1, $f0
    /* FB334 001FA3B4 A4AA6B35 */  ori        $11, $11, (0xBE2AAAA4 & 0xFFFF)
    /* FB338 001FA3B8 3E878C35 */  ori        $12, $12, (0x3C08873E & 0xFFFF)
    /* FB33C 001FA3BC 1FB2AD35 */  ori        $13, $13, (0xB94FB21F & 0xFFFF)
    /* FB340 001FA3C0 149CCE35 */  ori        $14, $14, (0x362E9C14 & 0xFFFF)
    /* FB344 001FA3C4 C2100046 */  mul.s      $f3, $f2, $f0
    /* FB348 001FA3C8 00288B44 */  mtc1       $11, $f5
    /* FB34C 001FA3CC 00308C44 */  mtc1       $12, $f6
    /* FB350 001FA3D0 00388D44 */  mtc1       $13, $f7
    /* FB354 001FA3D4 00408E44 */  mtc1       $14, $f8
...
.align 2
  .L001FA400:
    ...
    /* FB384 001FA404 00000144 */   mfc1      $1, $f0
...
.align 2
  .L001FA410:
    ...
    /* FB3B8 001FA438 00000244 */  mfc1       $2, $f0
    /* FB3BC 001FA43C 00000000 */  nop
    /* FB3C0 001FA440 0070A148 */  qmtc2.ni   $1, $vf14
    /* FB3C4 001FA444 0078A248 */  qmtc2.ni   $2, $vf15
    /* FB3C8 001FA448 8FFFE011 */  beqz       $15, .L001FA288
    /* FB3CC 001FA44C FFFFEF21 */   addi      $15, $15, -0x1 /* handwritten instruction */
    /* FB3D0 001FA450 97FFE011 */  beqz       $15, .L001FA2B0
    /* FB3D4 001FA454 FFFFEF21 */   addi      $15, $15, -0x1 /* handwritten instruction */
