...
glabel func_0022D7E0
    /* 12E760 0022D7E0 1900013C */  lui        $at, %hi(D_0018D080)
    /* 12E764 0022D7E4 80D02124 */  addiu      $at, $at, %lo(D_0018D080)
    /* 12E768 0022D7E8 300038D8 */  lqc2       $vf24, 0x30($at)
    /* 12E76C 0022D7EC 000026D8 */  lqc2       $vf6, 0x0($at)
    /* 12E770 0022D7F0 100027D8 */  lqc2       $vf7, 0x10($at)
    /* 12E774 0022D7F4 200028D8 */  lqc2       $vf8, 0x20($at)
    /* 12E778 0022D7F8 400034D8 */  lqc2       $vf20, 0x40($at)
    /* 12E77C 0022D7FC 500035D8 */  lqc2       $vf21, 0x50($at)
    /* 12E780 0022D800 600036D8 */  lqc2       $vf22, 0x60($at)
    /* 12E784 0022D804 700037D8 */  lqc2       $vf23, 0x70($at)
    /* 12E788 0022D808 1E00013C */  lui        $at, %hi(D_001D9A70)
    /* 12E78C 0022D80C 709A2124 */  addiu      $at, $at, %lo(D_001D9A70)
    /* 12E790 0022D810 00002BD8 */  lqc2       $vf11, 0x0($at)
...
.align 2
  .L0022D848:
    /* 12E7C8 0022D848 000081D8 */  lqc2       $vf1, 0x0($a0)
    /* 12E7CC 0022D84C 5B08F84B */  vmulw.xyzw $vf1, $vf1, $vf24w
    /* 12E7D0 0022D850 3C0BC24B */  vmove.xyz  $vf2, $vf1
    /* 12E7D4 0022D854 FFFFA520 */  addi       $a1, $a1, -0x1 /* handwritten instruction */
    ...
    /* 12E80C 0022D88C 00382248 */  qmfc2.ni   $v0, $vf7
    /* 12E810 0022D890 07004004 */  bltz       $v0, .L0022D8B0
    /* 12E814 0022D894 3C100200 */   dsll32    $v0, $v0, 0
    /* 12E818 0022D898 05004004 */  bltz       $v0, .L0022D8B0
    /* 12E81C 0022D89C 00000000 */   nop
    /* 12E820 0022D8A0 E9FFA014 */  bnez       $a1, .L0022D848
    /* 12E824 0022D8A4 FFFFC3A0 */   sb        $v1, -0x1($a2)
    /* 12E828 0022D8A8 0800E003 */  jr         $ra
    /* 12E82C 0022D8AC 00000000 */   nop
.align 2
  .L0022D8B0:
    /* 12E830 0022D8B0 E5FFA014 */  bnez       $a1, .L0022D848
    /* 12E834 0022D8B4 FFFFC0A0 */   sb        $zero, -0x1($a2)
    /* 12E838 0022D8B8 0800E003 */  jr         $ra
